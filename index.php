...
<ul><?php $d = '2019-02-04'; $t = 'homework 2019.02.04'; ?>
    <li><a href="<?php echo PARTDZ, $d; ?>_tz.html">Задание</a></li>
    <li><?php echo $t; ?>:
        <a href="<?php echo PART1, $d, '/index.php'; ?>">/index.php</a>,
        <a href="<?php echo PART1, $d, '/login.php'; ?>">/login.php</a>,
        <a href="<?php echo PART1, $d, '/upload.php'; ?>">/upload.php</a>
    </li>
</ul>
